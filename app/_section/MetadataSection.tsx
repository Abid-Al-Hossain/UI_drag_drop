...
const ROLE_OPTIONS: { value: DragDropState["role"]; label: string }[] = [
...
export default function MetadataSection({ state, update }: Props) {
  return <SectionCard title="Metadata" subtitle="Metadata controls for native dragdrop generation.">
...
<Select label="Role" value={state.role} options={ROLE_OPTIONS} onChange={(value) => update("role", value)} />
