...
export default function Page() {
  const [state, setState] = useState<DragDropState>(DEFAULT_DRAGDROP_STATE);
  ...
  return <AppShell contentOverflow="hidden"><PlaygroundLayout title="Drag Drop Studio" controls={controls} preview={output} /></AppShell>;
}
